                ...
                jsonData.forEach(function (p, index) {
                  ...
                  if (p.img !== '') {
                    ...
                    rowHtml += '<tr>' +
                        ...
                        '<td>' +
                        '<button class="accept btn btn-success btn-sm rounded-0" style="margin-right:5px;" id="'+p.pid+'"><i class="fas fa-check"></i></button>' +
