          ...
          success: function (data) {
            ...
            try {
                ...
                jsonData.forEach(function (p, index) {
                  ...
                  if (p.img !== '') {
                      postImagePath = '<img src="../postFiles/' + p.img + '" width="100" height="60" />';
                  }
                    ...
                    rowHtml += '<tr>' +
                        ...
                        '<td><div style="max-height: 100px; max-width: 340px; overflow-y: auto;">' + p.postData + '</div></td>' +
                        '<td>' + postImagePath + '</td>' +
                        '<td style="max-width: 100px; overflow: hidden; text-overflow: ellipsis;">' + p.postdate + " " + p.time+ '</td>'+
                        
                        '<td>' +
                        '<button class="view btn btn-warning btn-sm rounded-0" style="margin-right:5px;" id="'+p.pid+' "><i class="fas fa-eye"></i></button>' +
                        '<button class="reject btn btn-danger btn-sm rounded-0" id="' + p.pid + '"> <i class="fas fa-times"></i></button>' +
                        '</td>' +
                        '</tr>';
                });
